...
function Your_card() {
  ...
  <div className="flex justify-end space-x-4">
    <Link to="/"
      type="button"
      className=" text-decoration-none rounded-md border border-black px-3 py-2 text-sm font-semibold text-black shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
    >
      Back to shop
    </Link>
    {/* <button
